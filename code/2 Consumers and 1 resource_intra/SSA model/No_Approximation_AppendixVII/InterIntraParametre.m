...
classdef InterIntraParametre
    ...
    methods
        function obj = InterIntraParametre(consumer_number)
            ...
            obj.pair_meet(logical(eye(consumer_number))) = a * 1.25;             % a'_ij
            ...
            obj.pair_dessociate(logical(eye(consumer_number))) = 0.7;
                                                                            % d'_i
            ...
            obj.eat_resource = ones(1, consumer_number) * 0.05;             % k_il

            obj.resource_supply = ones(1) * 50;                            % R_a
            obj.resource_capacity = ones(1) * 2000;                          % K_0
...
%             rng(100)
            ...
            obj.mortality(1) = 0.016;
            obj.mortality(2) = 0.0171;
